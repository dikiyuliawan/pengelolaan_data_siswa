					...
					<div class="col-md-6">
						<div class="contact-form">
							...
							<form method="POST" action="/postregister">
                                @csrf
								<input class="input" type="text" name="nama_depan" placeholder="Nama Depan">
								<input class="input" type="text" name="nama_belakang" placeholder="Nama Belakang">
								<input class="input" type="text" name="agama" placeholder="Agama">
